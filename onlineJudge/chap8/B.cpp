...
public:
    ...
    float area() {
        m_area = 6.0 * side * side;
        return m_area;
    }
    void display() {
        std::cout << "Superficial area of Cube is";
    }
};
...
public:
    ...
    float area() {
        m_area = 4.0 * 3.14159 * radius * radius;
        return m_area;
    }
    void display() {
        std::cout << "Superficial area of Ball is";
    }
};
...
int main() {
    ...
    std::cout << "Please enter the height and base of the triangle:" << std::endl;
